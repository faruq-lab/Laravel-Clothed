<x-layout>
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">Welcome back to Clothed.my</p>
        </header>
        ...
        <form method="POST" action="/users/authenticate">
            ...
            <div class="mb-6">
                <button type="submit" class="bg-red-500 text-white rounded py-2 px-4 hover:bg-black">Sign In</button>
            </div>
            <div class="mt-8">
            <p>Don't have an acoount yet?</p>
            <a href="/register" class="text-red-500">Register now</a>
            </div>
