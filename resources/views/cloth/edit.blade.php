    ...
    <div class="flex flex-wrap justify-center">
        ...
        <div class="w-full md:w-1/2 p-4">
            <x-card class="mx-auto max-w-lg rounded mb-4">
                ...
                <form method="POST" action="/postings/{{$posting->id}}" enctype="multipart/form-data">
                    @csrf {{--cdsc--}}
                    @method('PUT')
                    <div class="mb-6">
                    ...
                    <div class="mb-6 text-center">
                        ...
                        <a href="/" class="text-black ml-4 rounded py-2 px-4 hover:bg-gray-500 hover:text-white">Cancel</a>
                    </div>
                </form>
            </x-card>
        </div>
